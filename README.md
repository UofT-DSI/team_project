...
* [Instructions](#instructions)
   ...
   + [Submission and Evluation](#submission-and-evaluation)
...
* Understand your business case and build a project plan.
* Understand your data and perform investigative analysis on your chosen dataset.

By the end of **Week 2**, you will be able to:
* Create a data visualization or a machine learning model as a team.
* Clearly document and present the results of your analysis, with emphasis on the business value.
* Reflect on your team processes, identify which strategies worked well for you, and think about where your team could have improved.
...
#### 4. Additional Resources for Getting Help
